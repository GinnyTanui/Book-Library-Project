        ...
        <header>
            ...
            <div className='relative'>
               ...
               <div className='absolute inset-0 flex flex-col items-center justify-center text-center bg-black bg-opacity-40 p-4'>
                <h1 className='text-blue-300 sm:text-3xl md:text-5xl font-bold mb-4 italic font-roboto '>WELCOME TO YOUR SERENE BOOK HAVEN!</h1> 
                <p className='text-white sm:text-sm md:text-lg font-lora '>Step into  a  peaceful sanctuary where stories come to life. In this tranquil corner of the web, explore 
